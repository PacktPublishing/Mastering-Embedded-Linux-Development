#!/bin/bash
# Format a microSD card for the BeaglePlay
# Mastering Embedded Linux Development
# Copyright (c) Chris Simmonds, 2024
...
# Check it is a flash drive (size < 120 GiB)
NUM_SECTORS=`cat /sys/block/${DRIVE}/size`
if [ $NUM_SECTORS -eq 0 -o $NUM_SECTORS -gt 240000000 ]; then
